    ...
    <div>
      ...
      <div className="col-md-12">
        <span className=" invy-text">
          <p>
            Here is a quick overview of filter elements to interchange with Pall
            filters. If you have any requirements on these components, or you
            are looking for a filter element that you do not find, you can
            always <a href="https://www.tu.biz/contact-us"> contact us </a> for
            a quote request. <br /> <br />
