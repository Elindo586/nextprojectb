...
import db from "../../../utils/elements-schroeder.json";
      ...
      <div>
        <div>
          <Head>
            ...
            <meta
              name="description"
              content="List of hydraulic filter elements to replace Schroeder filters."
            />
            <meta name="keywords" content="tu, schroeder, filters, elements " />
            ...
            <meta
              property="og:title"
              content=" TU | Hydraulic element replacement for Schroeder filters."
            />
        ...
        <div className="col-md-12">
          <div className=" invy-text">
            <p>
              ...
              Schroeder filters. If you have any requirements on these
              components, or you are looking for a filter element that you do
              not find, you can always{" "}
              <a href="https://www.tu.biz/contact-us"> contact us </a> for a
              quote request. <br /> <br />
